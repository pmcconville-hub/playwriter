...
After `session new --remote`, the public dial can drop (`1006`) then lose a race with the extension reconnect (`4008 Tunnel offline`). Execute used to fail immediately and tell you to install the Chrome extension.
