...
The agent prompt is now a few lines: the quoted `session new --remote` command, a pointer to `https://playwriter.dev/SKILL.md`, and a warning not to share the URL.
