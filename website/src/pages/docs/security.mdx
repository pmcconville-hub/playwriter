...
description: How Playwriter protects local automation and explicitly authorized remote tab sharing with scoped access, encryption, and revocation.
icon: lucide:shield
---
...
- **Scoped access.** The agent receives only the selected tab and popups it opens. Profile-wide cookie reads and writes, browser-wide destructive commands, and new-tab creation are blocked.
...
- **Privacy disclosure.** Remote traffic can contain screenshots, page content, URLs, input events, network data, and page-accessible cookies or browser storage. Read the [privacy policy](../privacy.mdx) before sharing sensitive tabs.
