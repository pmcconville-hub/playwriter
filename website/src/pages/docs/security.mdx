...
- **First-party domain.** Shared links are `https://playwriter.dev/r/{id}`. Frames are relayed in memory only; they are never stored, and response caching is off for these tunnels.
