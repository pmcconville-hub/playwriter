...
description: Debug Playwriter connection issues. Read relay logs, inspect CDP traffic, and fix common Chrome debugger problems.
icon: lucide:bug
---
...
```bash
playwriter -s 1 --timeout 30000 -e 'await state.page.goto("https://slow-site.com")'
```
