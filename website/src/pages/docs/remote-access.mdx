...
1. Click the **Remote control** button and confirm that the agent may read and control the tab
...
4. Click the button again anytime to **revoke access** — the URL dies instantly and is never reused
